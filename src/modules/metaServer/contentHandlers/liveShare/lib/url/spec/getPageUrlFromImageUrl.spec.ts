...
describe('getPageUrlFromImageUrl', () => {
  const cases: [imageUrl: string, pageUrl: string][] = [
    ...
    [
      'http://localhost:3000/web3/nfts/wallet/0xacdaEEb57ff6886fC8e203B9Dd4C2b241DF89b7a/score/91e65f4549ef72f1c623f704a6e9d70464c3d806456a5ad4582303e43920c8e1/preview/1600/900/img.png?chainId=1',
